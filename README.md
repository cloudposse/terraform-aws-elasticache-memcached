...
| <a name="input_transit_encryption_enabled"></a> [transit_encryption_enabled](#input\_transit_encryption_enabled) | Boolean flag to enable transit encryption (requires Memcached version 1.6.12+) | `bool` | `false` | no |
